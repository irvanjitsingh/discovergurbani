...
class AwesomeSpinner {
    ...
    public AwesomeSpinner(Context context, View view, int spinnerId, int arrayId, int spinnerType) {
        ...
        disabledTranslationIndices.add(2);
        disabledTranslationIndices.add(3);
        disabledTranslationIndices.add(4);
        disabledTranslationIndices.add(5);
        disabledTranslationIndices.add(6);
        disabledTranslationIndices.add(7);
        disabledTranslationIndices.add(8);
        disabledTranslationIndices.add(9);
        disabledTranslationIndices.add(10);
        disabledTranslationIndices.add(11);
        disabledTranslationIndices.add(13);
        disabledTranslationIndices.add(14);
        disabledTranslationIndices.add(15);
        disabledTranslationIndices.add(17);
        disabledTranslationIndices.add(18);
        disabledTranslationIndices.add(19);
        disabledTranslationIndices.add(20);
        disabledTranslationIndices.add(21);
        disabledTranslationIndices.add(22);
        disabledTranslationIndices.add(23);
        disabledTranslationIndices.add(24);
        disabledTranslationIndices.add(25);
        disabledTranslationIndices.add(26);
        disabledTranslationIndices.add(27);
        disabledTranslationIndices.add(28);
        disabledTranslationIndices.add(29);
        ...
        disabledTranslationIndices.add(36);
        disabledTranslationIndices.add(37);
        disabledTranslationIndices.add(38);
        disabledTranslationIndices.add(39);
        disabledTranslationIndices.add(40);
        ...
        disabledTranslationIndices.add(46);
        disabledTranslationIndices.add(47);
        disabledTranslationIndices.add(48);
        disabledTranslationIndices.add(49);
        disabledTranslationIndices.add(50);
